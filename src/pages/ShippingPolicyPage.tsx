      ...
      <div className="container-custom">
        ...
        <div className="max-w-3xl mx-auto prose">
          <section className="mb-8">
            ...
            <p>
              At LSkin, we strive to deliver your products as quickly and efficiently as possible. 
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              to import duties and taxes, which are the responsibility of the recipient. LSkin is not 
